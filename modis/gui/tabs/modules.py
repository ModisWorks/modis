...
from modis.tools import help, moduledb

logger = logging.getLogger(__name__)

github = Github("9dcdf9fc8a323cc12a8c3f511b09d2c855a3d7d7")
...
class Frame(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        super(Frame, self).__init__(parent, padding=0)
        ...
        self.module_list.column("#0", width=128)
        ...
        # Grid elements
        self.module_list.grid(column=0, row=0, padx=0, pady=0, sticky="W N S")
        yscrollbar.grid(column=1, row=0, padx=0, pady=0, sticky="W N S")
        self.module_ui_container.grid(column=2, row=0, padx=8, pady=8, sticky="W E N S")
        ...
        for module_name in self.moduledb.keys():
            ...
            if "__ui" in self.moduledb[module_name].keys():
    ...
    class HelpFrame(ttk.Frame):
        def __init__(self, parent, module_name):
            ...
            super(Frame.HelpFrame, self).__init__(parent, padding=8)
    ...
    class LogFrame(ttk.Frame):
        ...
        def __init__(self, parent, module_name):
            ...
            super(Frame.LogFrame, self).__init__(parent, padding=8)
